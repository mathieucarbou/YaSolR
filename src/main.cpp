...
Mycila::TaskManager loopTaskManager("loop()", 42);
// TODO: still need ioTaskManager ? Mycila::TaskManager ioTaskManager("ioTask()", 0);
...
void setup() {
  ...
  // assert(xTaskCreateUniversal(ioTask, "ioTask", 256 * 19, nullptr, 1, nullptr, xPortGetCoreID()) == pdPASS);
}
