...
void YaSolR::HADiscoveryControllerClass::publish() {
  ...
  Mycila::MQTTConfig mqttConfig = Mycila::MQTT.getConfig();
  ...
  Mycila::HADiscovery.setBaseTopic(mqttConfig.baseTopic);
  Mycila::HADiscovery.setWillTopic(mqttConfig.willTopic);
  ...
  Mycila::HADiscovery.publish(Mycila::HANumber("output1_dimmer_level_limit", "Output 1 Dimmer Level Limit", "/config/" KEY_OUTPUT1_DIMMER_LEVEL_LIMIT "/set", "/config/" KEY_OUTPUT1_DIMMER_LEVEL_LIMIT, Mycila::HANumberMode::SLIDER, 0, 100, 1, "mdi:flash", Mycila::HACategory::CONFIG));
  ...
  Mycila::HADiscovery.publish(Mycila::HANumber("output2_dimmer_level_limit", "Output 2 Dimmer Level Limit", "/config/" KEY_OUTPUT2_DIMMER_LEVEL_LIMIT "/set", "/config/" KEY_OUTPUT2_DIMMER_LEVEL_LIMIT, Mycila::HANumberMode::SLIDER, 0, 100, 1, "mdi:flash", Mycila::HACategory::CONFIG));
  ...
  Mycila::HAGauge freq = Mycila::HAGauge("grid_frequency", "Grid Frequency", "/grid/frequency", "frequency", nullptr, "Hz");
  freq.availabilityTopic = "/grid/online";
  freq.payloadAvailable = YASOLR_TRUE;
  freq.payloadNotAvailable = YASOLR_FALSE;

  Mycila::HAGauge volt = Mycila::HAGauge("grid_voltage", "Grid Voltage", "/grid/voltage", "voltage", nullptr, "V");
  volt.availabilityTopic = "/grid/online";
  volt.payloadAvailable = YASOLR_TRUE;
  volt.payloadNotAvailable = YASOLR_FALSE;
  Mycila::HADiscovery.publish(volt);

  Mycila::HADiscovery.publish(Mycila::HAGauge("router_energy", "Routed Energy", "/router/energy", "energy", nullptr, "kWh"));
  Mycila::HADiscovery.publish(Mycila::HAGauge("router_power", "Routed Power", "/router/power", "power", nullptr, "W"));
  ...
  Mycila::HANumber haDimmer1(NAME_OUTPUT1 "_dimmer_level", "Output 1 Dimmer Level", "/router/" NAME_OUTPUT1 "/dimmer/level/set", "/router/" NAME_OUTPUT1 "/dimmer/level", Mycila::HANumberMode::SLIDER, 0, 100, 1, "mdi:water-boiler");
  ...
  Mycila::HANumber haDimmer2(NAME_OUTPUT2 "_dimmer_level", "Output 2 Dimmer Level", "/router/" NAME_OUTPUT2 "/dimmer/level/set", "/router/" NAME_OUTPUT2 "/dimmer/level", Mycila::HANumberMode::SLIDER, 0, 100, 1, "mdi:water-boiler");
...
namespace YaSolR {
  HADiscoveryControllerClass HADiscoveryController;
} // namespace YaSolR
