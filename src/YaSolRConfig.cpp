...
#ifndef YASOLR_WIFI_CONNECTION_TIMEOUT
#define YASOLR_WIFI_CONNECTION_TIMEOUT 15
#endif

#ifndef YASOLR_CAPTURE_PORTAL_TIMEOUT
#define YASOLR_CAPTURE_PORTAL_TIMEOUT 180
#endif
...
void YaSolR::ConfigClass::begin() {
  ...
  Mycila::Config.configure(KEY_WIFI_CONNECTION_TIMEOUT, String(YASOLR_WIFI_CONNECTION_TIMEOUT));
  // portal
  Mycila::Config.configure(KEY_CAPTURE_PORTAL_TIMEOUT, String(YASOLR_CAPTURE_PORTAL_TIMEOUT));
  // ntp
