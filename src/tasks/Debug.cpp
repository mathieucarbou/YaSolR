...
Mycila::Task routerDebugTask("Router Debug", [](void* params) {
  ...
  logger.info(TAG, "[ JSY CH%d] U:%7.2f V | I: %5.2f A |            | P:%7.2f W | S:%7.2f VA | PF:%6.3f |             | F: %4.1f Hz |", 2, jsy.getVoltage2(), jsy.getCurrent2(), jsy.getPower2(), jsy.getApparentPower2(), jsy.getPowerFactor2(), jsy.getFrequency());
