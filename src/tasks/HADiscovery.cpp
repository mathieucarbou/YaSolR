...
Mycila::Task haDiscoveryTask("HADiscovery", Mycila::TaskType::ONCE, [](void* params) {
  ...
  haDiscovery.publish(Mycila::HAState("output1_bypass", "Output 1 Bypass", "/router/output1/bypass/state", YASOLR_ON, YASOLR_OFF, "running"));
  ...
  haDiscovery.publish(Mycila::HAOutlet("output1_relay", "Output 1 Bypass", "/router/output1/bypass/state/set", "/router/output1/bypass/state", YASOLR_ON, YASOLR_OFF));
  ...
  haDiscovery.publish(Mycila::HAState("output2_bypass", "Output 2 Bypass", "/router/output2/bypass/state", YASOLR_ON, YASOLR_OFF, "running"));
