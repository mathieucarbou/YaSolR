 ...
 * RFM12B module. An external switch allows either load to be selected as having 
 * thi higher priority.  If a local load is not provided, all surplus power is 
 * available for use by the remote load. 
 *
...
#define POLARITY_CHECK_MAXCOUNT 3 // sample sets
...
{  
  ...
  Serial.println();
  Serial.println("-------------------------------------");
  Serial.println("Sketch ID:      Mk2_withRemoteLoad_4a.ino");
  Serial.println();
