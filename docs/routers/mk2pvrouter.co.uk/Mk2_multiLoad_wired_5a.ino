/* Mk2_multiLoad_wired_5a.ino 
 *   is based on Mk2_multiLoad_wired_5.ino
 *     which is based on Mk2_multiLoad_CAT5_4.ino
 *
 ...
 *
 * January 2015: renamed as Mk2_multiLoad_wired_5a, with these changes:
...
{  
  ...
  Serial.println();
  Serial.println("-------------------------------------");
  Serial.println("Sketch ID:      Mk2_multiLoad_wired_5a.ino");
  Serial.println();
...
byte nextLogicalLoadToBeRemoved()
{
  byte retVal = noOfDumploads; 
  boolean success = false;
  for (byte index = (noOfDumploads -1); index >= 0 && !success; index--)
  {
