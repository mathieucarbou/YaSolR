 ...
 * outputs are able to drive an SSR directly.  Unlike a triac, an SSR can be CE-marked which
 * may be an important feature for some applications.
 *
 * This sketch has many similarities with Revision 5 of the Mk2i PV Router code that I 
...
{  
  ...
  Serial.println();
  Serial.println("-------------------------------------");
  Serial.println("Sketch ID:      Mk2_multiLoad_CAT5_4.ino");
  Serial.println();
