/* Mk2_fasterControl_twoLoads_1.ino
 *
...
//  digitalWrite (outOfRangeIndication, LED_OFF); 
  ...
  Serial.println();
  Serial.println("-------------------------------------");
  Serial.println("Sketch ID:      Mk2_fasterControl_twoLoads_1.ino");
  Serial.println();
...
*/  
  ...
  {     
    if (polarityConfirmedOfLastSampleV != NEGATIVE)
    {
      ...
      // not affect the value in the main energy bucket.  This complication is a fundamental limitation 
    ...
    if (sampleSetsDuringNegativeHalfOfMainsCycle == 3) 
    {
      ...
      {           
        ...
        loadHasJustChangedState = false; // flag is cleared by default            
