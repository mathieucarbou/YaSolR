...
OSS and Pro firmware are the same, except that the Pro version relies on commercial (paid) libraries which cannot be put in OSS project.
They provide some additional features and a better dashboard.

**Access to all Pro version is given in exchange of a 20 euros sponsoring**.

The Pro version gives access to all the perks of the Pro version below:
...
2. Make a donation of **20 euros or more** (through [Github](https://github.com/sponsors/mathieucarbou) or [Paypal](https://www.paypal.com/donate/?hosted_button_id=QJYRAPXGEDCNS)).
   Any donation of 20 euros or more will give access to the **Pro version and all the upcoming updates for an unlimited time**!
...
| <img src="./assets/img/hardware/ZCD.jpeg" style="width:150px">              | [ZCD module from Daniel S.](https://www.pcbway.com/project/shareproject/Zero_Cross_Detector_a707a878.html) (with DIN Rail enclosure)                                                                                                       |   15 €    |        5         |
