...
Here are the components below to build a [Mycila JSY App](http://mathieu.carbou.me/MycilaJSYApp/).
...
You can look in the [Mycila JSY App](http://mathieu.carbou.me/MycilaJSYApp/) project to find more information about how to setup remote JSY and the supported protocols.
...
See this blog post for more information: [Shelly Solar Diverter](blog/2024-07-01_shelly_solar_diverter.md)
...
This is the option and also what is used in the [Shelly Solar Router](blog/2024-07-01_shelly_solar_diverter.md).
...
If you are interested in one, please have a look at the availabilities in the [Pro](pro.md#zero-cross-detection-modules) page.
