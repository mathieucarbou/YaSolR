...
#ifndef YASOLR_WEBSITE_UPDATE_INTERVAL
#define YASOLR_WEBSITE_UPDATE_INTERVAL 1
#endif
...
namespace YaSolR {
  class Website {
    public:
      explicit Website(Mycila::TemperatureSensor* systemTempSensor) : _systemTempSensor(systemTempSensor) {}
      void begin();
      void loop();
      void update(bool skipWebSocketPush = false);
    ...
    private:
      ...
      Card _output1BypassSwitch = Card(&_dashboard, BUTTON_CARD, "Output 1 Bypass");
      ...
      Card _output2BypassSwitch = Card(&_dashboard, BUTTON_CARD, "Output 2 Bypass");
      ...
      Card _stateOutput1Bypass = Card(&_dashboard, STATUS_CARD, "Output 1 Bypass", DASH_STATUS_IDLE);
      ...
      Card _stateOutput2Bypass = Card(&_dashboard, STATUS_CARD, "Output 2 Bypass", DASH_STATUS_IDLE);
      ...
      Card _pinLiveOutput1Bypass = Card(&_dashboard, STATUS_CARD, "Output 1 Bypass Pin", DASH_STATUS_IDLE);
      ...
      Card _pinLiveOutput2Bypass = Card(&_dashboard, STATUS_CARD, "Output 2 Bypass Pin", DASH_STATUS_IDLE);
      ...
      Card _pinConfigOutput1Bypass = Card(&_dashboard, STATUS_CARD, "Output 1 Bypass Pin", DASH_STATUS_IDLE);
      ...
      Card _pinConfigOutput2Bypass = Card(&_dashboard, STATUS_CARD, "Output 2 Bypass Pin", DASH_STATUS_IDLE);
      ...
      Card _output1Bypass = Card(&_dashboard, BUTTON_CARD, "Output 1 Bypass");
      Card _output1BypassPin = Card(&_dashboard, TEXT_INPUT_CARD, "Output 1 Bypass Pin");
      Card _output1BypassType = Card(&_dashboard, DROPDOWN_CARD, "Output 1 Bypass Type");
      ...
      Card _output2Bypass = Card(&_dashboard, BUTTON_CARD, "Output 2 Bypass");
      Card _output2BypassPin = Card(&_dashboard, TEXT_INPUT_CARD, "Output 2 Bypass Pin");
      Card _output2BypassType = Card(&_dashboard, DROPDOWN_CARD, "Output 2 Bypass Type");
