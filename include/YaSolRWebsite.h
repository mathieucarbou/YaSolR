...
namespace YaSolR {
  class WebsiteClass {
    ...
    private:
      ...
      Card _output1DimmerPowerLimit = Card(&dashboard, SLIDER_CARD, "Dimmer Level Limit", "%", 0, 100, 1);
      ...
      Card _output2DimmerPowerLimit = Card(&dashboard, SLIDER_CARD, "Dimmer Power Limit", "%", 0, 100, 1);
