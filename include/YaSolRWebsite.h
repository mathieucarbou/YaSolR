...
namespace YaSolR {
  class WebsiteClass {
    ...
    private:
      Statistic _bootCountStat = Statistic(&dashboard, "Boot Count");
      Statistic _cpuCoresStat = Statistic(&dashboard, "CPU Cores");
      Statistic _cpuModelStat = Statistic(&dashboard, "CPU Model");
      Statistic _deviceIdStat = Statistic(&dashboard, "Device Id");
      Statistic _firmFilenameStat = Statistic(&dashboard, "Firmware Filename");
      Statistic _firmHashStat = Statistic(&dashboard, "Firmware Hash");
      Statistic _firmManufacturerStat = Statistic(&dashboard, "Firmware Manufacturer");
      Statistic _firmName = Statistic(&dashboard, "Firmware Name");
      Statistic _firmTimeStat = Statistic(&dashboard, "Firmware Timestamp");
      Statistic _firmVersionStat = Statistic(&dashboard, "Firmware Version");
      Statistic _gridFreqStat = Statistic(&dashboard, "Grid Frequency");
      Statistic _gridVoltStat = Statistic(&dashboard, "Grid Voltage");
      Statistic _heapMemoryTotalStat = Statistic(&dashboard, "Heap Memory Total");
      Statistic _heapMemoryUsageStat = Statistic(&dashboard, "Heap Memory Usage");
      Statistic _heapMemoryUsedStat = Statistic(&dashboard, "Heap Memory Used");
      Statistic _ipAddressStat = Statistic(&dashboard, "IP Address");
      Statistic _macAddressStat = Statistic(&dashboard, "MAC Address");
      Statistic _netModeStat = Statistic(&dashboard, "Network Mode");
      ...
      Statistic _trialRemainingStat = Statistic(&dashboard, "Trial Time Remaining");
#endif
      ...
      Card _mqttPublishInterval = Card(&dashboard, TEXT_INPUT_CARD, "MQTT Publish Interval");
