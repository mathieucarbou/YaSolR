...
float Mycila::RouterClass::getTotalRoutedEnergy() const {
  return _jsy->getEnergy1() + _jsy->getEnergyReturned1();
}
...
// TODO: ⚠️ power per output support ?
...
//   // more accurate
//   if (routing == 1)
//     return abs(_jsy->power1);

//   // approximation with P = U * U / R
//   const float u = Grid.getVoltage();
// TODO: resistance value from config
// TODO: autoCalibrate() function
